...
export const metadata: Metadata = {
  title: "Política de Privacidad — Cybertrust Security",
  description:
    "Política de privacidad de Cybertrust Security conforme a la Ley 21.719 sobre Protección de Datos Personales de Chile.",
};
